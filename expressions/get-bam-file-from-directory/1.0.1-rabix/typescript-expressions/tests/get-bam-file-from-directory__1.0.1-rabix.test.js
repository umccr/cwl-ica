...
var get_bam_file_from_directory__1_0_1_rabix_1 = require("../get-bam-file-from-directory__1.0.1-rabix");
...
describe('Test Shallow Directory Listing', function () {
    ...
    test("Test the get bam file from directory function non-recursively", function () {
        expect((0, get_bam_file_from_directory__1_0_1_rabix_1.get_bam_file_from_directory)(INPUT_SHALLOW_LISTING, INPUT_BAM_FILE_NAMEROOT)).toMatchObject(EXPECTED_SHALLOW_LISTING_OUTPUT_BAM_FILE);
    });
});
describe('Test Deep Directory Listing', function () {
    // Get script path
    test("Test the deep listing function", function () {
        expect((0, get_bam_file_from_directory__1_0_1_rabix_1.get_bam_file_from_directory)(INPUT_DEEP_LISTING, INPUT_BAM_FILE_NAMEROOT, true)).toMatchObject(EXPECTED_DEEP_LISTING_OUTPUT_BAM_FILE);
    });
});
