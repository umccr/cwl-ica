...
# ID/Docs
id: dragen-parse-rna-gene-expression-quantification-schema--4.4.0
label: dragen-parse-rna-gene-expression-quantification-schema v(4.4.0)
doc: |
    Documentation for dragen-parse-rna-gene-expression-
    quantification-schema v4.4.0
