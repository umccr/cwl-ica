...
# ID/Docs
id: dragen-build-reference-tarball--4.3.6
label: dragen-build-reference-tarball v(4.3.6)
doc: |
  Documentation for dragen-build-reference-tarball v4.3.6
...
steps:
  dragen_build_reference_tarball_step:
    label: dragen build reference tarball step
    doc: |
      Step to build the dragen reference tarball
    in:
      ht_reference:
        source: ht_reference
      output_directory:
      ...
      ht_build_rna_hashtable:
        source: ht_build_rna_hashtable
      ht_build_hla_hashtable:
        source: ht_build_hla_hashtable
      ht_seed_len:
        source: ht_seed_len
      ht_max_ext_seed_len:
        source: ht_max_ext_seed_len
      ht_max_seed_freq:
        source: ht_max_seed_freq
      ht_alt_liftover:
        source: ht_alt_liftover
      ht_alt_aware_validate:
        source: ht_alt_aware_validate
      ht_decoys:
        source: ht_decoys
      ht_suppress_decoys:
        source: ht_suppress_decoys
      ht_mask_bed:
        source: ht_mask_bed
      ht_pop_alt_contigs:
        source: ht_pop_alt_contigs
      ht_pop_alt_liftover:
        source: ht_pop_alt_liftover
      ht_pop_snps:
        source: ht_pop_snps
      ht_num_threads:
        source: ht_num_threads
      ht_max_table_chunks:
        source: ht_max_table_chunks
      ht_mem_limit:
        source: ht_mem_limit
      ht_size:
        source: ht_size
      ht_ref_seed_interval:
        source: ht_ref_seed_interval
      ht_soft_seed_freq_cap:
        source: ht_soft_seed_freq_cap
      ht_max_dec_factor:
        source: ht_max_dec_factor
      ht_rand_hit_hifreq:
        source: ht_rand_hit_hifreq
      ht_rand_hit_extend:
        source: ht_rand_hit_extend
      ht_target_seed_freq:
        source: ht_target_seed_freq
      ht_cost_coeff_seed_len:
        source: ht_cost_coeff_seed_len
      ht_cost_coeff_seed_freq:
        source: ht_cost_coeff_seed_freq
      ht_cost_penalty:
        source: ht_cost_penalty
      ht_cost_penalty_incr:
        source: ht_cost_penalty_incr
      ht_methylated:
        source: ht_methylated
      enable_cnv:
        source: enable_cnv
    out:
      - id: dragen_reference_tar
    run: ../../../tools/dragen-build-reference-tarball/4.2.4/dragen-build-reference-tarball__4.2.4.cwl
...
outputs:
  dragen_reference_tar:
    ...
    type: File
    outputSource: dragen_build_reference_tarball_step/dragen_reference_tar
