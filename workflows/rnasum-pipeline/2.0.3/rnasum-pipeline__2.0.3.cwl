...
# ID/Docs
id: rnasum-pipeline--2.0.3
label: rnasum-pipeline v(2.0.3)
doc: |
    Documentation for rnasum-pipeline v2.0.3
...
inputs:
  ...
  dragen_mapping_metrics:
    ...
    type: File
  # Must have at least one of salmon or kallisto
  salmon:
    label: salmon
    doc: |
...
steps:
  run_rnasum_step:
    ...
    out:
      ...
      - id: rnasum_html
    run: ../../../tools/rnasum/2.0.3/rnasum__2.0.3.cwl
