...
label: umccrise-with-dragen-germline-pipeline v(2.2.0--3.9.3)
doc: |
...
steps:
  ...
  run_dragen_germline_pipeline_step:
    ...
    in:
      ...
      # Hardcoded values (required by a step downstream)
  ...
  run_umccrise_pipeline_step:
    ...
    out:
      - id: output_directory
    run:
      ../../../tools/umccrise/2.2.0--0/umccrise__2.2.0--0.cwl
