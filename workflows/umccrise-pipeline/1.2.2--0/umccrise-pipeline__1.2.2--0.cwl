...
label: umccrise-pipeline v(1.2.2--0)
doc: |
...
steps:
  create_mount_paths_and_umccrise_tsv_input_jsons_step:
    ...
    run: ../../../expressions/create-predefined-mount-paths-and-umccrise-row-from-umccrise-schema/1.2.2--0/create-predefined-mount-paths-and-umccrise-row-from-umccrise-schema__1.2.2--0.cwl
  create_umccrise_tsv_step:
    ...
    run: ../../../tools/custom-create-umccrise-tsv/1.2.2--0/custom-create-umccrise-tsv__1.2.2--0.cwl
  run_umccrise_step:
