...
# ID/Docs
id: dragen-alignment-stage--4.4.4
label: dragen-alignment-stage v(4.4.4)
doc: |
    Documentation for dragen-alignment-stage v4.4.4
...
steps:
  ...
  run_dragen_alignment_step:
    ...
    run: ../../../tools/dragen-wgts-alignment-step/4.4.4/dragen-wgts-alignment-step__4.4.4.cwl
    out:
      - id: output_directory
