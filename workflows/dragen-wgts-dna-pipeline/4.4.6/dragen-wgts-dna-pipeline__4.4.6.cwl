...
inputs:
  ...
  cnv_caller_options:
    ...
    type:
      - "null"
      - ../../../schemas/dragen-cnv-caller-options/4.4.0/dragen-cnv-caller-options__4.4.0.yaml#dragen-cnv-caller-options
  ...
  mrjd_options:
    ...
    type:
      - "null"
      - ../../../schemas/dragen-mrjd-options/4.4.0/dragen-mrjd-options__4.4.0.yaml#dragen-mrjd-options
  ...
  somatic_tmb_options:
    ...
    type:
      - "null"
      - ../../../schemas/dragen-tmb-options/4.4.0/dragen-tmb-options__4.4.0.yaml#dragen-tmb-options
  ...
  somatic_msi_options:
    ...
    type:
      - "null"
      - ../../../schemas/dragen-msi-options/4.4.0/dragen-msi-options__4.4.0.yaml#dragen-msi-options
  ...
  targeted_caller_options:
    ...
    type:
      - "null"
      - ../../../schemas/dragen-targeted-caller-options/4.4.0/dragen-targeted-caller-options__4.4.0.yaml#dragen-targeted-caller-options
...
steps:
  ...
  run_get_variant_calling_options_as_schemas_step:
    ...
    run: ../../dragen-create-wgts-dna-variant-calling-options-object/4.4.0/dragen-create-wgts-dna-variant-calling-options-object__4.4.0.cwl
