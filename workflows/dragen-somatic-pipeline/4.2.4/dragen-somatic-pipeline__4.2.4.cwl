...
label: dragen-somatic-pipeline v(4.2.4)
doc: |
...
steps:
  run_dragen_somatic_step:
    ...
    in:
      ...
      # Phased / MNV Calling options
      vc_combine_phased_variants_distance:
        source: vc_combine_phased_variants_distance
      vc_combine_phased_variants_max_vaf_delta:
        source: vc_combine_phased_variants_max_vaf_delta
      vc_mnv_emit_component_calls:
        source: vc_mnv_emit_component_calls
      # dbSNP annotation
      dbsnp_annotation:
    ...
    run: ../../../tools/dragen-somatic/4.2.4/dragen-somatic__4.2.4.cwl
