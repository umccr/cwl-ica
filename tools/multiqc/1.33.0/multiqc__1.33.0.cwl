...
# ID/Docs
id: multiqc--1.33.0
label: multiqc v(1.33.0)
doc: |
  Documentation for multiqc v1.33.0
...
hints:
  ResourceRequirement:
    ...
    ramMin: 8000
  DockerRequirement:
    dockerPull: ghcr.io/multiqc/multiqc:v1.33
...
inputs:
  ...
  sample_filters_tsv:
    ...
    doc: |
      TSV file with multiple columns
      Used to filter samples in the report.
    type: File?
    inputBinding:
