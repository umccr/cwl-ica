...
# ID/Docs
id: custom-create-tso500-samplesheet--1.2.0
label: custom-create-tso500-samplesheet v(1.2.0)
doc: |
...
inputs:
  ...
  tso500_samples:
    ...
    type:
      - type: array
        items: ../../../schemas/tso500-sample/1.2.0/tso500-sample__1.2.0.yaml#tso500-sample
        inputBinding:
