...
label: dragen-alignment-step v(4.4.4)
doc: |
        ...
        entry: |
          ${
            ...
            */
            ...
            /*
            Check if enable_rna is set? If so we turn off all other rna enabling parameters
            */
            if (inputs.dragen_options.enable_rna){
              var rna_obj = {
                "enable_rna": true,
                "enable_rna_gene_fusion": false,
                "enable_rna_quantification": false,
                "enable_rna_splice_variant": false
              };
            } else {
              var rna_obj = {};
            }
