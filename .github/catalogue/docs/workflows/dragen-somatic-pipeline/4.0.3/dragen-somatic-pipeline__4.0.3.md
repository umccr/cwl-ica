...
dragen-somatic-pipeline 4.0.3 workflow
======================================

## Table of Contents
  
- [Overview](#dragen-somatic-pipeline-v403-overview)  
- [Visual](#visual-workflow-overview)  
- [Links](#related-links)  
- [Inputs](#dragen-somatic-pipeline-v403-inputs)  
- [Steps](#dragen-somatic-pipeline-v403-steps)  
- [Outputs](#dragen-somatic-pipeline-v403-outputs)  
- [ICA](#ica)  


## dragen-somatic-pipeline v(4.0.3) Overview



  
> ID: dragen-somatic-pipeline--4.0.3  
> md5sum: 7b0258b6365c592750c53281d87d5f29

### dragen-somatic-pipeline v(4.0.3) documentation
  
Documentation for dragen-somatic-pipeline v4.0.3
...
[![dragen-somatic-pipeline__4.0.3.svg](../../../../images/workflows/dragen-somatic-pipeline/4.0.3/dragen-somatic-pipeline__4.0.3.svg)](https://github.com/umccr/cwl-ica/raw/main/.github/catalogue/images/workflows/dragen-somatic-pipeline/4.0.3/dragen-somatic-pipeline__4.0.3.svg)
## Related Links
  
- [CWL File Path](../../../../../../workflows/dragen-somatic-pipeline/4.0.3/dragen-somatic-pipeline__4.0.3.cwl)  
...
**Optional:** `True`  
**Type:** `['boolean', <cwl_utils.parser.cwl_v1_1.InputEnumSchema object at 0x7fd3962176e0>]`  
**Docs:**  
...
## dragen-somatic-pipeline v(4.0.3) Steps
...
> ID: dragen-somatic-pipeline--4.0.3/dragen_somatic_output_directory  
...
> ID: dragen-somatic-pipeline--4.0.3/multiqc_output_directory  
...
> ID: dragen-somatic-pipeline--4.0.3/normal_bam_out  
...
> ID: dragen-somatic-pipeline--4.0.3/somatic_snv_vcf_hard_filtered_out  
...
> ID: dragen-somatic-pipeline--4.0.3/somatic_snv_vcf_out  
...
> ID: dragen-somatic-pipeline--4.0.3/somatic_structural_vcf_out  
...
> ID: dragen-somatic-pipeline--4.0.3/tumor_bam_out  
