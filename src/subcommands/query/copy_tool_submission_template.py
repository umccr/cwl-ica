...
class CopyToolSubmissionTemplate(CopySubmissionTemplate):
    """Usage:
    cwl-ica [options] copy-tool-submission-template help
    cwl-ica [options] copy-tool-submission-template (--ica-workflow-run-instance-id=<run_instance_id>)
                                                        [--prefix=<prefix>]
                                                        [--curl]
...
Example:
    cwl-ica copy-tool-submission-template --ica-workflow-run-instance-id wfr.123456789 --prefix validation-workflow
    """
