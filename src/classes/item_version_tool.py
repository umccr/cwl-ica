...
class ItemVersionTool(ItemVersion):
    """
    An ItemVersionTool has the following properties
    ...
    * set_md5sum -> sets the md5sum attribute
    ...
    def set_cwl_object(self):
        ...
        # Split file name
        name, version = get_name_version_tuple_from_cwl_file_path(self.cwl_file_path, items_dir=get_tools_dir())

        # Set here
        self.cwl_obj = CWLTool(cwl_file_path=self.cwl_file_path, name=name, version=version)
