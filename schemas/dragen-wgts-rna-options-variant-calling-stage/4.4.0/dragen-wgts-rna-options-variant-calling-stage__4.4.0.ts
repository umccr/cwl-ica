import { DragenWgtsAlignmentOptions } from "../../dragen-wgts-alignment-options/4.4.0/dragen-wgts-alignment-options__4.4.0"
import { DragenRnaGeneExpressionQuantificationOptions } from "../../dragen-rna-gene-expression-quantification-options/4.4.0/dragen-rna-gene-expression-quantification-options__4.4.0"
import { DragenRnaGeneFusionDetectionOptions } from "../../dragen-rna-gene-fusion-detection-options/4.4.0/dragen-rna-gene-fusion-detection-options__4.4.0"
import { FileProperties as IFile } from "cwl-ts-auto"
import { DragenMafConversionOptions } from "../../dragen-maf-conversion-options/4.4.0/dragen-maf-conversion-options__4.4.0"
import { DragenNirvanaAnnotationOptions } from "../../dragen-nirvana-annotation-options/4.4.0/dragen-nirvana-annotation-options__4.4.0"
import { BamInput } from "../../bam-input/1.0.0/bam-input__1.0.0"
import { CramInput } from "../../cram-input/1.0.0/cram-input__1.0.0"
import { DragenSnvVariantCallerOptions } from "../../dragen-snv-variant-caller-options/4.4.0/dragen-snv-variant-caller-options__4.4.0"
import { DragenRnaSpliceVariantCallerOptions } from "../../dragen-rna-splice-variant-caller-options/4.4.0/dragen-rna-splice-variant-caller-options__4.4.0"
