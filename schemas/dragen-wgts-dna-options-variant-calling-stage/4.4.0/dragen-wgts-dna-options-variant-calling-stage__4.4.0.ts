...
import {DragenCnvCallerOptions} from "../../dragen-cnv-caller-options/4.4.0/dragen-cnv-caller-options__4.4.0";
import {
	DragenMafConversionOptions
} from "../../dragen-maf-conversion-options/4.4.0/dragen-maf-conversion-options__4.4.0";
import {DragenSvCallerOptions} from "../../dragen-sv-caller-options/4.4.0/dragen-sv-caller-options__4.4.0";
import {
	DragenNirvanaAnnotationOptions
} from "../../dragen-nirvana-annotation-options/4.4.0/dragen-nirvana-annotation-options__4.4.0";
import {
	DragenTargetedCallerOptions
} from "../../dragen-targeted-caller-options/4.4.0/dragen-targeted-caller-options__4.4.0";
...
} from "../../dragen-wgts-alignment-options/4.4.0/dragen-wgts-alignment-options__4.4.0";
import {DragenTmbOptions} from "../../dragen-tmb-options/4.4.0/dragen-tmb-options__4.4.0";
import {DragenMsiOptions} from "../../dragen-msi-options/4.4.0/dragen-msi-options__4.4.0";
import {DragenMrjdOptions} from "../../dragen-mrjd-options/4.4.0/dragen-mrjd-options__4.4.0";
