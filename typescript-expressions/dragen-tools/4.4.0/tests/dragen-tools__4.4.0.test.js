...
// Imports
var dragen_tools__4_4_0_1 = require("../dragen-tools__4.4.0");
// Data imports
// Read in the file data/dragen_default_config.cfg
var fs_1 = __importDefault(require("fs"));
var path_1 = __importDefault(require("path"));
var config_file_path = path_1.default.join(__dirname, 'data', 'dragen_default_config.cfg');
var config_file_data = fs_1.default.readFileSync(config_file_path, 'utf8');
var config_json_file_path = path_1.default.join(__dirname, 'data', 'dragen_default_config.json');
var config_json_file_data = fs_1.default.readFileSync(config_json_file_path, 'utf8');
var config_thin_file_path = path_1.default.join(__dirname, 'data', 'dragen_default_config.thin.cfg');
var config_thin_file_data = fs_1.default.readFileSync(config_thin_file_path, 'utf8');
var fastq_list_row_json = path_1.default.join(__dirname, 'data', 'fastq_list_row.json');
var fastq_list_row_data = JSON.parse(fs_1.default.readFileSync(fastq_list_row_json, 'utf8'));
var fastq_list_row_expected_contents_file = path_1.default.join(__dirname, 'data', 'fastq_list_row_expected.csv');
var fastq_list_row_expected_contents_data = fs_1.default.readFileSync(fastq_list_row_expected_contents_file, 'utf-8');
// Toml to JSON conversion test
describe('Test toml file', function () {
    test('Compare full default cfg to expected output json', function () {
        expect((0, dragen_tools__4_4_0_1.toml_to_json)(config_file_data)).toEqual(JSON.parse(config_json_file_data));
    });
});
// JSON to TOML conversion test
describe('Test json file', function () {
    test('Compare output json to shrinked toml', function () {
        expect((0, dragen_tools__4_4_0_1.dragen_to_config_toml)(JSON.parse(config_json_file_data))).toEqual(config_thin_file_data);
    });
});
var dragen_merge_list = [
    {
        "enable_cnv": true,
        "dbsnp": null,
...
describe('Test merge file', function () {
    test('Compare output json to shrinked toml', function () {
        expect((0, dragen_tools__4_4_0_1.dragen_merge_options)(dragen_merge_list)).toEqual(expected_output);
    });
});
var merge_filter_object_1 = {
    "enable_vcf_indexing": true,
    "fastq_offset": 33,
...
var merge_filter_object_2 = {
    "enable_cnv": true,
    "enable_vcf_compression": true,
    "enable_vcf_indexing": false,
};
var expected_filter_output = {
    "enable_vcf_indexing": true
};
describe('Test filter', function () {
    test('Test filtering object keys to subset', function () {
        expect((0, dragen_tools__4_4_0_1.filter_object_by_keys)(merge_filter_object_1, merge_filter_object_2)).toEqual(expected_filter_output);
    });
});
describe('Test alignment options', function () {
    test('alignment options to toml', function () {
        var input_self = [
            "L2301197",
            {
                "name": "hg38",
...
describe("Test Fastq List rows", function () {
    test("Test Fastq List Rows to Csv", function () {
        expect((0, dragen_tools__4_4_0_1.generate_fastq_list_csv)(fastq_list_row_data).contents).toEqual(fastq_list_row_expected_contents_data);
    });
});
